        ...
        <div className="animate-fade-in w-full max-w-7xl mx-auto space-y-8">
            ...
            {isFormVisible && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 lg:pl-[250px] animate-fade-in">
                    ...
                    ></div>
                    <div className="relative z-10 w-full max-w-5xl max-h-[90vh] overflow-y-auto custom-scrollbar rounded-3xl animate-slide-up shadow-[0_20px_40px_rgba(0,0,0,0.1)]">
                        <OrderFormPage
